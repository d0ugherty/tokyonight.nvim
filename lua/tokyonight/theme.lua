...
function M.setup()
  ...
  theme.highlights = {
    ...
    Function = { fg = c.blue1, style = options.styles.functions }, -- function name (also: methods for classes)
    ...
    ["@punctuation.bracket"] = { fg = c.magenta2 }, -- For brackets and parens.
    ...
    ["@field"] = { fg = c.green2 }, -- For fields.
    ["@property"] = { fg = c.green2 },
